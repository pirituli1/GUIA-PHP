...
<?php 
$ruta="/var/www/html/img"; // Indicar ruta (Asegurarse de tener permiso de escribir en está dirección)

// Revisa si se subió un archivo y si el archivo pesa más que 0 
